...
REM
REM Generated by Vivado on Mon Jan 03 17:03:59 -0600 2022
...
echo "xvhdl --incr --relax -prj ESCOMIPS_vhdl.prj"
call xvhdl  --incr --relax -prj ESCOMIPS_vhdl.prj -log xvhdl.log
